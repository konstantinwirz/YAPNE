...
public class Parser {
    ...
    public Net parse(final String input) {
        net = new Net();
    ...
    public void newArc(final String id, final String sourceId, final String targetId) {
        ...
        Element source = net.getElementById(sourceId);
        assert source != null;

        Element target = net.getElementById(targetId);
        assert target != null;
    ...
    public void setPosition(final String id, final String x, final String y) {
        ...
        Element element = net.getElementById(id);
        assert element != null;

        element.setPosition(new Position(Integer.parseInt(x), Integer.parseInt(y)));
    }
    ...
    public void setMarking(final String id, final String marking) {
        ...
        Place place = (Place) net.getElementById(id);
        assert place != null;
