...
public class Utils {
     ...
     */
    public static <T extends Comparable<? super T>> boolean inRange(T value, T min, T max) {
     ...
     * @see #inRange
     */
    public static <T extends Comparable<? super T>> T ensureRange(T value, T min, T max) {
